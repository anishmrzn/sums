...
export const PlatformDetail: React.FC<PlatformDetailProps> = ({
      ...
      case 'cogknit':
        return {
          ...
          solutions: [
            ...
            { name: 'Technical & Vocational Training', audience: 'Empowering specialized skills development through step-by-step progress tracking.' },
          ],
      ...
      case 'sip':
        return {
          ...
          solutions: [
            ...
            { name: 'Industrial Placement Program', audience: 'Active pipelines aligning local coding talents directly to global remote tech teams.' },
          ],
      ...
      case 'academia':
        return {
          ...
          solutions: [
            ...
            { name: 'University Registrar Engine',   audience: 'Scalable student lifecycles tracking transcripts, courses, and fees.' },
          ],
      ...
      default:
        return {
          ...
          solutions: [
            ...
            { name: 'Vocational Up-skilling Camp', audience: 'Fast-paced courses addressing current employment requirements.' },
          ],
  ...
  // Desktop layout transition: content panel slides from centered → left-aligned
  ...
  const renderSections = () => (
    <>
      ...
      {/* TESTIMONIALS */}
      <motion.section id="testimonials" className="scroll-mt-24 border-t border-white/5 pt-12" {...FADE_UP}>
        <span className="text-[#FD4400] text-[10px] font-semibold tracking-[0.25em] uppercase block mb-3">
          06 / Testimonials
        </span>
        <h2 className="font-serif text-xl md:text-3xl font-medium text-white mb-6">
      ...
      {/* CONTACT */}
      <motion.section id="contact" className="scroll-mt-24 border-t border-white/5 pt-12 pb-12" {...FADE_UP}>
        <span className="text-[#FD4400] text-[10px] font-semibold tracking-[0.25em] uppercase block mb-3">
          07 / Connect
        </span>
        <h2 className="font-serif text-xl md:text-3xl font-medium text-white mb-6">
  ...
  if (isMobile) {
    return (
      <div className="relative w-full text-white">
        {/* Sticky horizontal scrollable section nav */}
        <nav
          className="sticky top-[65px] z-30 bg-[#040507]/95 backdrop-blur-md border-b border-white/5 flex gap-2 px-4 py-3 overflow-x-auto"
          ...
          {sections.map(sec => {
            ...
            return (
              <button
                ...
                className={`relative shrink-0 px-3 py-1.5 rounded-full text-[10px] font-semibold uppercase tracking-wider transition-all duration-300 cursor-pointer ${
                  isActive
        ...
        {/* Full-width content */}
        <div className="px-5 pt-10 pb-32 space-y-16">
          {renderSections()}
        </div>
      </div>
    );
  ...
  return (
    <div ref={containerRef} className="relative w-full text-white">
      {/* ─── STICKY ORBIT HEADER (slides left on scroll) ─── */}
      <div
      ...
      >
        ...
        <svg
          viewBox="0 0 100 100"
          className="absolute w-[300px] h-[300px] md:w-[380px] md:h-[380px] pointer-events-none overflow-visible z-30"
        >
          {(() => {
            ...
            return (
              <g>
                <line
                  ...
                  stroke="rgba(253, 68, 0, 0.2)" strokeWidth="0.5" strokeDasharray="1.5 1.5"
                  style={{ transition: 'all 0.5s cubic-bezier(0.25, 1, 0.5, 1)' }}
                />
                <line
                  x1="50" y1="50" x2={x2} y2={y2}
                  stroke="#FD4400" strokeWidth="0.75" strokeLinecap="round" opacity="0.8"
                  style={{
      ...
      <div className="relative w-full z-10 -mt-[100vh] flex justify-end">
        {/* Spacer pushes content to the right half */}
