  ...
  <div id="contact" className="mx-auto px-4 sm:px-6 md:px-8 lg:px-16 xl:px-28 py-10 md:py-16 xl:py-20">
    ...
    >
      <div className="flex items-center gap-3 mb-4 justify-center px-4">
        <div className="hidden sm:block w-8 h-[2px] bg-[#FF5C00] flex-shrink-0" />
        <span className="text-[#FF5C00] text-xs sm:text-sm md:text-base font-extrabold tracking-[0.2em] sm:tracking-[0.35em] uppercase font-sans text-center">We Would Love To Hear From You</span>
        <div className="hidden sm:block w-8 h-[2px] bg-[#FF5C00] flex-shrink-0" />
      </div>
      <h2 className="font-sans font-black text-4xl md:text-5xl xl:text-6xl leading-[0.95] tracking-tight text-white">
        Connect <span className="text-[#FF5C00]" style={{ textShadow: '0 0 40px rgba(255,92,0,0.4)' }}>With Us</span>
      </h2>
