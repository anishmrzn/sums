...
import { SLIDER_LOGOS } from '../../data/logos';

export const LogoSlider: React.FC = () => {
  const loopedLogos = [...SLIDER_LOGOS, ...SLIDER_LOGOS, ...SLIDER_LOGOS];

  return (
    <div className="w-full bg-[#040507] border-y border-white/5 py-5 overflow-hidden relative pointer-events-none">
      <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6">
        <div className="flex-shrink-0 px-6 md:pl-10 z-20 bg-[#040507] text-center md:text-left">
        ...
        <div className="relative w-full md:flex-grow overflow-hidden select-none">
